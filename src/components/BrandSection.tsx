        ...
        <div className="max-w-6xl mx-auto">
          <div className="space-y-16">
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Frame & Lensa Tersedia</h2>
              <p className="text-gray-600 max-w-2xl mx-auto mb-12">
                Kami menyediakan berbagai pilihan frame dan lensa berkualitas tinggi dari merek terpercaya
              </p>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                <div className="flex flex-col items-center justify-center p-4 grayscale hover:grayscale-0 transition-all duration-300 transform hover:scale-105">
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Partner Lensa Kami</h2>
              <p className="text-gray-600 max-w-2xl mx-auto mb-12">
                Diproduksi oleh manufaktur lensa terkemuka untuk kualitas terbaik
              </p>
